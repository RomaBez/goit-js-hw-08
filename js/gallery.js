...
// 1. Обрали список з майбутніми зображеннями//

const imageEl = document.querySelector('.gallery');

// 2. Згенерували шаблонний рядок із розміткою забражень //
...
// 4. Додали обробник подій для кліку на картинку //
...
const largeImage = event.target.dataset.source;
    ...
    // 5. Використали бібліотеку для додавання модального вікна //
